...
async def restart_bot(_, message):
    ...
    buttons.data_button("Shutdown", "botrestart confirm sd")
    button = buttons.build_menu(2)
    await mu.reply("Are you sure you want to restart the bot ?!", button)
...
async def confirm_restart(_, query):
    ...
    if data[1] == "confirm":
        ...
        restart_message = await mu.reply("Restarting...", message=reply_to)
        await mu.delete()
        await TgClient.stop()
