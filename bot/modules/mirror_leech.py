...
from ..helper.telegram_helper.message_utils import get_tg_link_message
    ...
    async def new_event(self):
        ...
        if is_telegram_link(self.link):
            try:
                ...
                await self.MessageUtils.reply(f"ERROR: {e}")
        ...
        if isinstance(reply_to, list):
            ...
            nextmsg = await self.MessageUtils.reply(" ".join(b_msg))
        ...
        if (
            ...
            await self.MessageUtils.reply(
                COMMAND_USAGE["mirror"][0], COMMAND_USAGE["mirror"][1]
            )
            await self.remove_from_same_dir()
            return
