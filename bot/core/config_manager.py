...
class Config:
    ...
    BOT_HAS_SPOILER = False
    BOT_SUPPORTS_STREAMING = False
    BOT_PROTECT_CONTENT = False
    BOT_DISABLE_NOTIFICATION = False
    BOT_DISABLE_WEB_PAGE_PREVIEW = False
    FORWARD_TO_CHAT = ""
    CLEAR_HISTORY_AFTER_RESTART = False
    SEND_MSG_DELAY = 10
    DELETE_LINK = False
